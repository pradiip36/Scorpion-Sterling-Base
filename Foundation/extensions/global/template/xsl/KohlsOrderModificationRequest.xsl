...
<xsl:stylesheet version="1.0" 
				...
				xmlns:mod="http://com/kohls/ch/cc/services/webservice/notification/mod" 
    ...
    <web:order xmlns:web='http://webservice.services.cc.ch.kohls.com'>
		...
		<web:modificationReason>Product Availability</web:modificationReason>
		...
		<web:campaign xmlns:web='http://webservice.services.cc.ch.kohls.com'>
			<web:folderName>Order_Modification</web:folderName>
			<web:objectName>Kohls_Order_Modification</web:objectName>
		</web:campaign>
