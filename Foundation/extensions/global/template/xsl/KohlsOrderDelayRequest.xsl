...
<xsl:stylesheet version="1.0" 
    ...
    <web:order xmlns:web='http://webservice.services.cc.ch.kohls.com'>
		...
		<web:delayReason>Product Availability</web:delayReason>
		...
		<web:campaign xmlns:web='http://webservice.services.cc.ch.kohls.com'>
			<web:folderName>Order_Delay</web:folderName>
			<web:objectName>TEST_UPDATES_Order_Delay</web:objectName>
		</web:campaign>
