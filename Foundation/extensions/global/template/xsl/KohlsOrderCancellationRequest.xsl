...
<xsl:stylesheet version="1.0" 
    ...
    <web:order xmlns:web='http://webservice.services.cc.ch.kohls.com'>
		...
		<web:cancelReason>Product Availability</web:cancelReason>
		...
		<web:pickupStore>
				...
				<web:storeName>
					<xsl:value-of
					select="Organization[Order/OrderLines/OrderLine/@ShipNode = @OrganizationCode]/@OrganizationName" />
				</web:storeName>
			</web:pickupStore>
	    <web:paymentDetails>
                  <!--Optional:-->
		...
		<web:campaign xmlns:web='http://webservice.services.cc.ch.kohls.com'>
			<web:folderName>Order_Cancellation</web:folderName>
			<web:objectName>Kohls_Order_Cancellation</web:objectName>
		</web:campaign>
