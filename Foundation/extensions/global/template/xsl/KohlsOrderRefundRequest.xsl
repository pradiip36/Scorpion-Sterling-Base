...
<xsl:stylesheet version="1.0" 
    ...
    <web:order xmlns:web='http://webservice.services.cc.ch.kohls.com'>
		...
		<web:refundReason>Expired Order</web:refundReason>
		...
		<web:campaign xmlns:web='http://webservice.services.cc.ch.kohls.com'>
			<web:folderName>Expired_Order_Refund</web:folderName>
			<web:objectName>Expired_Order_Refund_Test</web:objectName>
		</web:campaign>
