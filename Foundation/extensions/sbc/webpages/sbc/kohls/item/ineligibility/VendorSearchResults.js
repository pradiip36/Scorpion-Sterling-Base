...
sc.sbc.kohls.item.ineligibility.VendorSearchResults = function(config) {
    ...
    sc.sbc.kohls.item.ineligibility.VendorSearchResults.superclass.constructor.call(this, config);
}
Ext.extend(sc.sbc.kohls.item.ineligibility.VendorSearchResults, sc.plat.ui.ExtensibleScreen, {
    className: 'sc.sbc.kohls.item.ineligibility.VendorSearchResults',
    getUIConfig: sc.sbc.kohls.item.ineligibility.VendorSearchResultsUIConfig,
    namespaces: {
	...
	getUrl : function() {
		return sc.sbc.helper.AppHelper.getAjaxURL("getVendorListForInelg", "/sbc/item");
	},
...
Ext.reg('seaVendorSearchResults', sc.sbc.kohls.item.ineligibility.VendorSearchResults);