...
function initSearch(){
	...
	if(<%=itemSearchInput%>){
		itemSearch = new sc.sbc.kohls.item.ineligibility.ItemSearch({SearchInput:<%=itemSearchInput%>});
		isSearchInputPresent = true;
	}else{
		itemSearch = new sc.sbc.kohls.item.ineligibility.ItemSearch();
	}
	containerUtil.drawScreen(itemSearch, {title : "Item Ineligibility",
