...
sc.sbc.kohls.item.eligibility.itemElgPopup = function(config) {
    sc.sbc.kohls.item.eligibility.itemElgPopup.superclass.constructor.call(this, config);
}
Ext.extend(sc.sbc.kohls.item.eligibility.itemElgPopup, sc.plat.ui.ExtensibleScreen, {
    className: 'sc.sbc.kohls.item.eligibility.itemElgPopup',
    getUIConfig: sc.sbc.kohls.item.eligibility.itemElgPopupUIConfig,
    namespaces: {
...
Ext.reg('xtype_name2', sc.sbc.kohls.item.eligibility.itemElgPopup);