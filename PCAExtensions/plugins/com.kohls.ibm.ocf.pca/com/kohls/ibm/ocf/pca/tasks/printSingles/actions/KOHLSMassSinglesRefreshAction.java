...
public class KOHLSMassSinglesRefreshAction extends YRCAction{

	public static final String ACTION_ID="com.kohls.ibm.ocf.pca.tasks.printSingles.actions.KOHLSMassSinglesRefreshAction";
	...
	public void execute(IAction action) {
		...
		if(currentPage instanceof KOHLSMassSinglesPrintScreen){
			((KOHLSMassSinglesPrintScreenBehavior)((KOHLSMassSinglesPrintScreen)currentPage).getBehavior()).doRefresh();
		}		
	}
}