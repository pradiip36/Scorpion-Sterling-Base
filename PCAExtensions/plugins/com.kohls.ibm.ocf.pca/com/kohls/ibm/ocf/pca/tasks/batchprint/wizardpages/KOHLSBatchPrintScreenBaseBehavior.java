 ...
 */
public abstract class KOHLSBatchPrintScreenBaseBehavior  extends YRCWizardPageBehavior  {

	private Object input ;
	protected KOHLSBatchPrintScreen parent;
	public static String WIZARD_ID = "com.kohls.ibm.ocf.pca.tasks.batchprint.wizards.KOHLSBatchPrintScreenBaseBehavior";  
	public KOHLSBatchPrintScreenBaseBehavior(KOHLSBatchPrintScreen parent, String FORM_ID, Object input) {
		super(parent);
		this.parent = parent;
		this.input = input;
	}
