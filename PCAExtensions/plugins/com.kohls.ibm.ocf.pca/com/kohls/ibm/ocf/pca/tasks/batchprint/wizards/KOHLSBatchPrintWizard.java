...
public class KOHLSBatchPrintWizard extends YRCWizard
{
	...
	private KOHLSBatchPrintWizardBehavior myBehavior;
	Object wizardInput;
	
	public static final String FORM_ID = "com.kohls.ibm.ocf.pca.tasks.batchprint.wizards.KOHLSBatchPrintWizard";
	public KOHLSBatchPrintWizard(Composite parent, int style, Object wizardInput)
	{
	...
	{
		myBehavior = new KOHLSBatchPrintWizardBehavior(this, FORM_ID, wizardInput);
		return myBehavior;
	}
