...
public class KOHLSPrintStorePickSlipCloseAction extends YRCAction {
	
	public static final String ACTION_ID="com.kohls.ibm.ocf.pca.tasks.printStorePickSlips.actions.KOHLSPrintStorePickSlipCloseAction";
	...
	public void execute(IAction action) {
		...
		if(currentPage instanceof KOHLSStorePickSlipPrintPage){
			((KOHLSStorePickSlipPrintPageBehavior)((KOHLSStorePickSlipPrintPage)currentPage).getBehavior()).performClose();
		}		
	}
