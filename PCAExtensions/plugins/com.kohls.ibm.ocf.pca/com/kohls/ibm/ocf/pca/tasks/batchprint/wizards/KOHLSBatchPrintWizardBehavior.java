 ...
 * 
 */
public class KOHLSBatchPrintWizardBehavior extends YRCWizardBehavior
		
{
	 ...
	 * @param wizardInput
	 */
	public KOHLSBatchPrintWizardBehavior(Composite ownerComposite,
	...
	{
		if (pageIdToBeShown.equals(KOHLSBatchPrintScreen.FORM_ID))
		{
			KOHLSBatchPrintScreen page = new KOHLSBatchPrintScreen(
