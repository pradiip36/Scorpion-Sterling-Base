...
public class KOHLSPrintStorePickSlipBulkPrintAction extends YRCAction {

	public KOHLSPrintStorePickSlipBulkPrintAction() {
	...
	public void execute(IAction arg0) {
		...
		if(currentPage instanceof KOHLSStorePickSlipPrintPage){
			((KOHLSStorePickSlipPrintPageBehavior)((KOHLSStorePickSlipPrintPage)currentPage).getBehavior()).launchBulkPrintPopUp();
		}		
	}
