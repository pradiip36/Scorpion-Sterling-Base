 ...
 * 
 */
public class KOHLSReprintBatchWizardBehavior extends YRCWizardBehavior
		
{
	 ...
	 * @param wizardInput
	 */
	public KOHLSReprintBatchWizardBehavior(Composite ownerComposite,
	...
	{
		if (pageIdToBeShown.equals(KOHLSReprintBatchScreen.FORM_ID))
		{
			KOHLSReprintBatchScreen page = new KOHLSReprintBatchScreen(
