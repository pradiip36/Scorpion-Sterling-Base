 ...
 */
public abstract class KOHLSReprintBatchScreenBaseBehavior  extends YRCWizardPageBehavior  {

	private Object input ;
	protected KOHLSReprintBatchScreen parent;
	public static String WIZARD_ID = "com.kohls.ibm.ocf.pca.tasks.reprintbatch.wizards.KOHLSReprintBatchWizard";  
	public KOHLSReprintBatchScreenBaseBehavior(KOHLSReprintBatchScreen parent, String FORM_ID, Object input) {
		super(parent);
		this.parent = parent;
		this.input = input;
	}
	...
	public abstract void doPrint (Element input);
