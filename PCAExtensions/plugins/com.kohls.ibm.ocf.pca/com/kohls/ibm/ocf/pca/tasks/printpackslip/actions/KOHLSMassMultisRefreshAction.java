...
public class KOHLSMassMultisRefreshAction extends YRCAction{

	public static final String ACTION_ID="com.kohls.ibm.ocf.pca.tasks.printpackslip.actions.KOHLSMassMultisRefreshAction";
	...
	public void execute(IAction action) {
		...
		if(currentPage instanceof KOHLSPrintPackSlip){
			((KOHLSPrintPackSlipBehavior)((KOHLSPrintPackSlip)currentPage).getBehavior()).doRefresh();
		}		
	}
}