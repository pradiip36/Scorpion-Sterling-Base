#!/usr/bin/ksh
#
#     Program Name:  OF_Manage_Integration.sh
#           Author:  Mark Yearling
#     Date Created:  2011, January
#  Program Purpose:  This is an OF script used for managing integration
#                    servers based on the arguments passed.
#         Argument:  <process_name> <action> <release>
#          Example:  OF_Manage_Integration.sh ShipConfirmationServer stop of
#
# Modification Log:
...
# EXECUTE THE SCRIPT
readonly cmdstr="${K_SH}/is_sterling_admin.ksh -t i -s ${process_name} -o ${action_type}"
